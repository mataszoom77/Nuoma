...
<form method='post' action='irasytiKategorija.php'>
  <div class="form-row" >
    ...
    <div class="form-row">
    <div class="form-group col-md-12">
      <label for="inputPassword4">Naudojimas</label>
      <input type="text" name='naudojimas' class="form-control" id="inputPassword4" required>
    </div>
  
  <div class="form-group col-md-12">
    <label for="inputAddress">Medziaga</label>
    <input type="text" name='medziaga' class="form-control" id="inputAddress" required>
  </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-12">
      <label for="inputPassword4">Skirta</label>
      <input type="text" name='skirta' class="form-control" id="inputPassword4" required>
    </div>

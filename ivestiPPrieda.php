...
<form method='post' action='irasytiPPrieda.php'>
  <div class="form-row" >
    ...
    <div class="form-row">
    <div class="form-group col-md-12">
      <label for="inputPassword4">Kiekis</label>
      <input type="text" name='kiekis' class="form-control" id="inputPassword4" required>
    </div>
	<div class="form-group col-md-12">
      <label for="inputPassword4">Svoris</label>
      <input type="text" name='svoris' class="form-control" id="inputPassword4" required>
    </div>

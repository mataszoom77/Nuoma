...
?>
    <html>
        ...
        <body>   
			<div class="mt-3 mb-3">
			<a class="btn btn-primary" style="margin:auto;" href="index.php" role="button">Atgal į prisijungimo langą</a>
			</div>
			<div align="center">
				<div class="container">
					<table class="center" style="border-radius: 5px; padding: 20px;"> <tr><td>

...
{ header("Location: logout.php");exit;}
  ...
  $_SESSION['prev'] = "procregister";
		...
		{ // vardas  geras,  nuskaityti vartotoja is DB
		 ...
		 $sql = "INSERT INTO " . TBL_USERS. " (username, password, userid, userlevel, email,timestamp, vardas, pavarde, telefonas, adresas, asmens_kodas)
          VALUES ('$user', '$pass', '$userid','$ulevel', '$mail', null, '$vardas', ' $pavarde', '$tel', '$adresas', '$kodas')";
